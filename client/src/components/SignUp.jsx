  ...
  return (
    ...
    <div className='w-1/2 mx-auto flex flex-col justify-center'>
      ...
      <form onSubmit={handleRegister}>
        ...
        <div className="mb-4">
          <label className="block text-gray-300 mb-1">Gender <span className="text-red-500">*</span></label>
          <div className="flex justify-center sm:justify-start">
            <label className={`flex items-center text-gray-300 mr-2 p-2 rounded-md ${formData.gender === 'boy' ? 'border-2 border-cyan-500' : 'border border-cyan-/-aqua-500'}`}>
              <input
                type="radio"
                name="gender" 
                value="boy" 
            ...
            <label className={`flex items-center text-gray-300 p-2 rounded-md ${formData.gender === 'girl' ? 'border-2 border-cyan-500' : 'border border-cyan-/-aqua-500'}`}>
              <input
                type="radio"
                name="gender" 
                value="girl" 
