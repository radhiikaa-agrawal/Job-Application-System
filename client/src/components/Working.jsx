          ...
          <div className="flex flex-col gap-10">
            {
              ...
              <div 
                key={index} 
                onClick={() => handleWorkClick(works.name)}
                className="flex items-center gap-4 cursor-pointer hover:bg-mine-shaft-900 p-2 rounded-lg transition-all"
              >
